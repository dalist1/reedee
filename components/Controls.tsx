...
export default function Controls({ goToNextPage, goToPreviousPage ,currentPageText}){
    ...
    return(
        <div className="z-50 flex h-[4.5rem] justify-between items-center w-96 fixed font-medium text-sm bottom-4 p-4 bg-slate-950/80 backdrop-blur-sm rounded-full">
            <button className='flex cursor-pointer justify-items items-center p-3 text-gray-500 hover:text-white rounded-full'>
                <FaHeart size={20}/>
            </button>
            ...
            <button className='flex cursor-pointer justify-items items-center p-3 text-gray-500 hover:text-white rounded-full' onClick={goToNextPage}>
